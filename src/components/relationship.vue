<template>
    <div id = '关系图' :style = 'div_css'>
      ...
      id = '单选框3' variant="primary-filled" default-value="1">
          <t-radio-button value="1">Suspension Mode</t-radio-button>
          <t-radio-button value="2">Columnar Mode</t-radio-button>
      </t-radio-group>
    </div>
</template>
